...
const SOCIAL_LINKS = [
  ...
  {
    name: 'Twitter',
    link: 'https://twitter.com/brunoamill',
  }
];
      ...
      <Container className="container-fluid">
        <div className="row">
          <div className="col-lg-8 col-md-12">
            ...
            <P>Ao lado você pode inserir diferentes jogos, categorias e publishers par a nossa maravilhosa loja de jogos.</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
             ...
             <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de dúvidas ou sugestões, só ir em alguns de nossos links :) </P>
